...
echo "   1. Go to capsulehub.tilantra.com → Profile → Generate API Key"
echo "   2. Run: /capsule-login  (paste your cht- key when prompted)"
echo ""
echo " Works with Google and email/password accounts alike."
echo " Your API key is stored permanently — no need to log in again."
echo "────────────────────────────────────────────"
